 ...
 *
 */
public class GPSFilterComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(GPSFilter.component_conf);
      mgr.registerFactory(prop, new GPSFilter(), new GPSFilter());

      // Create a component
      RTObject_impl comp = mgr.createComponent("GPSFilter");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        GPSFilterComp init = new GPSFilterComp();
