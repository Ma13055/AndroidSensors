 ...
 */
public class GPSFilter implements RtcNewFunc, RtcDeleteFunc, RegisterModuleFunc {

//  Module specification
//  <rtc-template block="module_spec">
    public static String component_conf[] = {
    	    "implementation_id", "GPSFilter",
    	    "type_name",         "GPSFilter",
    	    "description",       "Filtering of the GPS information",
    	    "version",           "1.0.0",
...
//  </rtc-template>
    ...
    public void registerModule() {
        ...
        manager.registerFactory(prop, new GPSFilter(), new GPSFilter());
    }
}
