...
/*!
 * @class GyroscopeFilterComp
 * @brief Standalone component Class
 *
 */
public class GyroscopeFilterComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(GyroscopeFilter.component_conf);
      mgr.registerFactory(prop, new GyroscopeFilter(), new GyroscopeFilter());

      // Create a component
      RTObject_impl comp = mgr.createComponent("GyroscopeFilter");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        GyroscopeFilterComp init = new GyroscopeFilterComp();
