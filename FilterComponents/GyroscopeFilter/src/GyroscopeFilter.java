 ...
 */
public class GyroscopeFilter implements RtcNewFunc, RtcDeleteFunc, RegisterModuleFunc {

//  Module specification
//  <rtc-template block="module_spec">
    public static String component_conf[] = {
    	    "implementation_id", "GyroscopeFilter",
    	    "type_name",         "GyroscopeFilter",
    	    "description",       "Filtering of the GyroscopeSensor information",
    	    "version",           "1.0.0",
...
//  </rtc-template>
    ...
    public RTObject_impl createRtc(Manager mgr) {
        return new GyroscopeFilterImpl(mgr);
    }
    ...
    public void registerModule() {
        ...
        manager.registerFactory(prop, new GyroscopeFilter(), new GyroscopeFilter());
    }
}
