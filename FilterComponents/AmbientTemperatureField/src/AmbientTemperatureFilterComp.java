// -*- Java -*-
/*!
 * @file AmbientTemperatureFilterComp.java
...
/*!
 * @class AmbientTemperatureFilterComp
 * @brief Standalone component Class
 *
 */
public class AmbientTemperatureFilterComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(AmbientTemperatureFilter.component_conf);
      mgr.registerFactory(prop, new AmbientTemperatureFilter(), new AmbientTemperatureFilter());

      // Create a component
      RTObject_impl comp = mgr.createComponent("AmbientTemperatureFilter");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        AmbientTemperatureFilterComp init = new AmbientTemperatureFilterComp();
