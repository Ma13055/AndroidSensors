 ...
 */
public class PressureFilter implements RtcNewFunc, RtcDeleteFunc, RegisterModuleFunc {

//  Module specification
//  <rtc-template block="module_spec">
    public static String component_conf[] = {
    	    "implementation_id", "PressureFilter",
    	    "type_name",         "PressureFilter",
...
//  </rtc-template>
    ...
    public RTObject_impl createRtc(Manager mgr) {
        return new PressureFilterImpl(mgr);
    }
    ...
    public void registerModule() {
        ...
        manager.registerFactory(prop, new PressureFilter(), new PressureFilter());
    }
}
