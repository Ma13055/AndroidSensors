...
/*!
 * @class PressureFilterComp
 * @brief Standalone component Class
 *
 */
public class PressureFilterComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(PressureFilter.component_conf);
      mgr.registerFactory(prop, new PressureFilter(), new PressureFilter());

      // Create a component
      RTObject_impl comp = mgr.createComponent("PressureFilter");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        PressureFilterComp init = new PressureFilterComp();
