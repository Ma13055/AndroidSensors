// -*- Java -*-
/*!
 * @file  AccelerationFilterImpl.java
...
/*!
 * @class AccelerationFilterImpl
 * @brief Filtering of the AccelerationSensor information
 *
 * Androidセンサ取得用アプリケーション「GetAcceleration」に対応するフィルタコンポーネント
 ...
 *
 */
public class AccelerationFilterImpl extends DataFlowComponentBase {
   ...
   */
	public AccelerationFilterImpl(Manager manager) {  
        super(manager);
...
//
	...
	private String createFilename(){
		...
		String Name = "GetAcceleration_"+startYear+"_"+sMonth+"_"+sDay+"_"+sHour+"_"+sMinute+".txt";
		return Name;
	}
