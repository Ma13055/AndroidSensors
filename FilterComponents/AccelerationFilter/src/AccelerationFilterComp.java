// -*- Java -*-
/*!
 * @file AccelerationFilterComp.java
...
/*!
 * @class AccelerationFilterComp
 * @brief Standalone component Class
 *
 */
public class AccelerationFilterComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(AccelerationFilter.component_conf);
      mgr.registerFactory(prop, new AccelerationFilter(), new AccelerationFilter());

      // Create a component
      RTObject_impl comp = mgr.createComponent("AccelerationFilter");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        AccelerationFilterComp init = new AccelerationFilterComp();
