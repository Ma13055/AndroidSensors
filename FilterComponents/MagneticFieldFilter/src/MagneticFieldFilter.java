 ...
 */
public class MagneticFieldFilter implements RtcNewFunc, RtcDeleteFunc, RegisterModuleFunc {

//  Module specification
//  <rtc-template block="module_spec">
    public static String component_conf[] = {
    	    "implementation_id", "MagneticFieldFilter",
    	    "type_name",         "MagneticFieldFilter",
    	    "description",       "Filtering of the MagneticFieldSensor information",
    	    "version",           "1.0.0",
...
//  </rtc-template>
    ...
    public RTObject_impl createRtc(Manager mgr) {
        return new MagneticFieldFilterImpl(mgr);
    }
    ...
    public void registerModule() {
        ...
        manager.registerFactory(prop, new MagneticFieldFilter(), new MagneticFieldFilter());
    }
}
