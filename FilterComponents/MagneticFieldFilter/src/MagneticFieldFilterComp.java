// -*- Java -*-
/*!
 * @file MagneticFieldFilterComp.java
...
/*!
 * @class MagneticFieldFilterComp
 * @brief Standalone component Class
 *
 */
public class MagneticFieldFilterComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(MagneticFieldFilter.component_conf);
      mgr.registerFactory(prop, new MagneticFieldFilter(), new MagneticFieldFilter());

      // Create a component
      RTObject_impl comp = mgr.createComponent("MagneticFieldFilter");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        MagneticFieldFilterComp init = new MagneticFieldFilterComp();
