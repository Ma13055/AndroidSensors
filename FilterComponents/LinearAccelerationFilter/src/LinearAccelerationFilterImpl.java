// -*- Java -*-
/*!
 * @file  LinearAccelerationFilterImpl.java
...
/*!
 * @class LinearAccelerationFilterImpl
 * @brief Filtering of the LinearAccelerationSensor information
 *
 * Androidセンサ取得用アプリケーション「GetLinearAcceleration」に対応するフィルタコンポーネント
 * 限定された型でしか送信することのできないセンサ情報に対し、
 * LinearAccelerationSensorに適したデータ型に変換して出力を行う。
 ...
 *
 * In:LinearAccelerationSensorData
 ...
 *
 */
public class LinearAccelerationFilterImpl extends DataFlowComponentBase {
   ...
   */
	public LinearAccelerationFilterImpl(Manager manager) {  
        super(manager);
        ...
        m_outData2D_val = new TimedAcceleration2D();
        m_outData2D = new DataRef<TimedAcceleration2D>(m_outData2D_val);
        m_OutTimedAcceleration2DOut = new OutPort<TimedAcceleration2D>("OutTimedAcceleration2D", m_outData2D);
    ...
    protected ReturnCode_t onInitialize() {
        ...
        addOutPort("OutTimedAcceleration2D", m_OutTimedAcceleration2DOut);
...
//
	...
	private void setOutPort(Object array[]){
        ...
        try {
        	...
        	TimedAcceleration2D subAccele2D = new TimedAcceleration2D(tm,new Acceleration2D(x,y));
			...
			m_OutTimedAcceleration2DOut.write(subAccele2D);
	...
	private String createFilename(){
		...
		String Name = "GetLinearAcceleration_"+startYear+"_"+sMonth+"_"+sDay+"_"+sHour+"_"+sMinute+".txt";
		return Name;
	}
    ...
    /*!
     * Output dataX from "GetAcceleration" is input.
     * - Type: TimedDouble
     * - Number: 1
     * - Unit: m/s^2
     */
    ...
    /*!
     * Output dataY from "GetAcceleration" is input.
     * - Type: TimedDouble
     * - Number: 1
     * - Unit: m/s^2
     */
    ...
    /*!
     * Output dataZ from "GetAcceleration" is input.
     * - Type: TimedDouble
     * - Number: 1
     * - Unit: m/s^2
     */
    ...
    /*!
     * Acceleration sensor data in the X , Y and Z axis of the
     * filtered are output.
    ...
    protected TimedAcceleration2D m_outData2D_val;
    protected DataRef<TimedAcceleration2D> m_outData2D;
    /*!
     * Acceleration sensor data in the X and Y axis of the
     * filtered are output.
     * - Type: TimedAcceleration2D
     * - Number: 1
     * - Unit: m/s^2
     */
    protected OutPort<TimedAcceleration2D> m_OutTimedAcceleration2DOut;

    protected TimedDouble m_outDoubleX_val;
    protected DataRef<TimedDouble> m_outDoubleX;
    /*!
     * Acceleration sensor data in the X-axis of the filtered is
     * output.
     * - Type: TimedDouble
     * - Number: 1
     * - Unit: m/s^2
    ...
    /*!
     * Acceleration sensor data in the Y-axis of the filtered is
     * output.
     * - Type: TimedDouble
     * - Number: 1
     * - Unit: m/s^2
    ...
    /*!
     * Acceleration sensor data in the Z-axis of the filtered is
     * output.
     * - Type: TimedDouble
     * - Number: 1
     * - Unit: m/s^2
