// -*- Java -*-
/*!
 * @file LinearAccelerationFilterComp.java
...
/*!
 * @class LinearAccelerationFilterComp
 * @brief Standalone component Class
 *
 */
public class LinearAccelerationFilterComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(LinearAccelerationFilter.component_conf);
      mgr.registerFactory(prop, new LinearAccelerationFilter(), new LinearAccelerationFilter());

      // Create a component
      RTObject_impl comp = mgr.createComponent("LinearAccelerationFilter");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        LinearAccelerationFilterComp init = new LinearAccelerationFilterComp();
