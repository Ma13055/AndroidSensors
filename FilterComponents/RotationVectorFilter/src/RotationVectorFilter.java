// -*- Java -*-
/*!
 * @file RotationVectorFilter.java
 * @date $Date$
 *
...
/*!
 * @class RotationVectorFilter
 * @brief Filtering of the RotationVectorSensor information
 */
public class RotationVectorFilter implements RtcNewFunc, RtcDeleteFunc, RegisterModuleFunc {

//  Module specification
//  <rtc-template block="module_spec">
    public static String component_conf[] = {
    	    "implementation_id", "RotationVectorFilter",
    	    "type_name",         "RotationVectorFilter",
    	    "description",       "Filtering of the RotationVectorSensor information",
    	    "version",           "1.0.0",
...
//  </rtc-template>
    ...
    public RTObject_impl createRtc(Manager mgr) {
        return new RotationVectorFilterImpl(mgr);
    }
    ...
    public void registerModule() {
        ...
        manager.registerFactory(prop, new RotationVectorFilter(), new RotationVectorFilter());
    }
}
