// -*- Java -*-
/*!
 * @file RotationVectorFilterComp.java
...
/*!
 * @class RotationVectorFilterComp
 * @brief Standalone component Class
 *
 */
public class RotationVectorFilterComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(RotationVectorFilter.component_conf);
      mgr.registerFactory(prop, new RotationVectorFilter(), new RotationVectorFilter());

      // Create a component
      RTObject_impl comp = mgr.createComponent("RotationVectorFilter");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        RotationVectorFilterComp init = new RotationVectorFilterComp();
