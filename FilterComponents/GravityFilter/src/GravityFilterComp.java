...
/*!
 * @class GravityFilterComp
 * @brief Standalone component Class
 *
 */
public class GravityFilterComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(GravityFilter.component_conf);
      mgr.registerFactory(prop, new GravityFilter(), new GravityFilter());

      // Create a component
      RTObject_impl comp = mgr.createComponent("GravityFilter");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        GravityFilterComp init = new GravityFilterComp();
