 ...
 */
public class LightFilter implements RtcNewFunc, RtcDeleteFunc, RegisterModuleFunc {

//  Module specification
//  <rtc-template block="module_spec">
    public static String component_conf[] = {
    	    "implementation_id", "LightFilter",
    	    "type_name",         "LightFilter",
    	    "description",       "Filtering of the LightSensor information",
    	    "version",           "1.0.0",
...
//  </rtc-template>
    ...
    public RTObject_impl createRtc(Manager mgr) {
        return new LightFilterImpl(mgr);
    }
    ...
    public void registerModule() {
        ...
        manager.registerFactory(prop, new LightFilter(), new LightFilter());
    }
}
