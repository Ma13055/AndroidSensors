...
/*!
 * @class LightFilterComp
 * @brief Standalone component Class
 *
 */
public class LightFilterComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(LightFilter.component_conf);
      mgr.registerFactory(prop, new LightFilter(), new LightFilter());

      // Create a component
      RTObject_impl comp = mgr.createComponent("LightFilter");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        LightFilterComp init = new LightFilterComp();
