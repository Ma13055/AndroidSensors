...
/*!
 * @class ProximityFilterComp
 * @brief Standalone component Class
 *
 */
public class ProximityFilterComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(ProximityFilter.component_conf);
      mgr.registerFactory(prop, new ProximityFilter(), new ProximityFilter());

      // Create a component
      RTObject_impl comp = mgr.createComponent("ProximityFilter");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        ProximityFilterComp init = new ProximityFilterComp();
