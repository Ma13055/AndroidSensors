// -*- Java -*-
/*!
 * @file OrientationFilterComp.java
...
/*!
 * @class OrientationFilterComp
 * @brief Standalone component Class
 *
 */
public class OrientationFilterComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(OrientationFilter.component_conf);
      mgr.registerFactory(prop, new OrientationFilter(), new OrientationFilter());

      // Create a component
      RTObject_impl comp = mgr.createComponent("OrientationFilter");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        OrientationFilterComp init = new OrientationFilterComp();
