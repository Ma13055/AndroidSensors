 ...
 */
public class OrientationFilter implements RtcNewFunc, RtcDeleteFunc, RegisterModuleFunc {

//  Module specification
//  <rtc-template block="module_spec">
    public static String component_conf[] = {
    	    "implementation_id", "OrientationFilter",
    	    "type_name",         "OrientationFilter",
...
//  </rtc-template>
    ...
    public RTObject_impl createRtc(Manager mgr) {
        return new OrientationFilterImpl(mgr);
    }
    ...
    public void registerModule() {
        ...
        manager.registerFactory(prop, new OrientationFilter(), new OrientationFilter());
    }
}
