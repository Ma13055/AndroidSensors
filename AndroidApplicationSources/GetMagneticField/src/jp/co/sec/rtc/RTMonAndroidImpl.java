...
import jp.ac.it.shibaura.android.magnetic.RTMonAndroidOfMagneticField;
...
public class RTMonAndroidImpl extends RTCBase {
	...
	private static RTMonAndroidOfMagneticField	myRTC = null;
	 ...
	 * @param mode データ型
	 */
	public RTMonAndroidImpl(RTMonAndroidOfMagneticField myRTC, RTCService rtcService) {
