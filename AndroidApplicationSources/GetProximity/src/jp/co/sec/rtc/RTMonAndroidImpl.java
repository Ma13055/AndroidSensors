...
import jp.ac.it.shibaura.android.proximity.RTMonAndroidOfProximity;
...
public class RTMonAndroidImpl extends RTCBase {
	...
	private static RTMonAndroidOfProximity	myRTC = null;
	...
	TimedDouble dataCm = new TimedDouble();
	 ...
	 * @param mode データ型
	 */
	public RTMonAndroidImpl(RTMonAndroidOfProximity myRTC, RTCService rtcService) {
	...
	private void ioControl(){
		...
		outPortDoubleCm.write(dataCm);						// データをoutPortに書き出す。
		Logger4RTC.debug(TAG, "onExecute");
