...
import jp.ac.it.shibaura.android.rotationVector.RTMonAndroidOfRotationVector;
...
public class RTMonAndroidImpl extends RTCBase {
	...
	private static RTMonAndroidOfRotationVector	myRTC = null;
	...
	private OutPort<TimedDouble>		outPortDoubleCos;
	...
	TimedDouble dataCos = new TimedDouble();
	 ...
	 * @param mode データ型
	 */
	public RTMonAndroidImpl(RTMonAndroidOfRotationVector myRTC, RTCService rtcService) {
...
/*		String pName = RTMonAndroidProfile.InPort1;
	...
	private void initOutPort(){
		...
		String CosName = RTMonAndroidProfile.OutPort4;
		String AccName = RTMonAndroidProfile.OutPort5;
		TimedDouble XX = new TimedDouble();
		TimedDouble YY = new TimedDouble();
		TimedDouble ZZ = new TimedDouble();
		TimedDouble Cos = new TimedDouble();
		...
		outPortDoubleCos = new OutPort<TimedDouble>(CosName, Cos);
		...
		rtcService.addOutPort(outPortDoubleCos);
	...
	private void ioControl(){
		...
		outPortDoubleCos.write(dataCos);
