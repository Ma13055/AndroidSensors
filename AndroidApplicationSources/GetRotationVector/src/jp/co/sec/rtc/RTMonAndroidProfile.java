...
public class RTMonAndroidProfile {
	...
	public static final String Name				= "RotationVectorSensor";
	public static final String ImplementationId	= "RotationVectorSensor";
	...
	public static final String OutPort4			= "OutDoubleCos";
	public static final String OutPort5			= "OutDoubleAccuracy";
}
