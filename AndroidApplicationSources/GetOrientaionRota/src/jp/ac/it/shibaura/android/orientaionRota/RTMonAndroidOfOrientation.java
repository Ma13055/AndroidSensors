 ...
 */
package jp.ac.it.shibaura.android.orientaionRota;
...
public class RTMonAndroidOfOrientation extends Activity {
	...
	private double dataAzimuth = 0;			//傾きセンサ方位角情報
	private double dataPitch = 0;			//傾きセンサ傾斜角情報
	private double dataRoll = 0;				//傾きセンサ回転角情報
...
//			rtcService.setLongConfig(RTMonAndroidProfile.ConfigName1, 0);
	...
	public RTCTime getRTCTime(){
		RTCtm.set((int)sys.getTime(), (int)System.nanoTime());
		return RTCtm;
	}
