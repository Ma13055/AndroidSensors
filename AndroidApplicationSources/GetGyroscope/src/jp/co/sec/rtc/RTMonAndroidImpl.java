...
import jp.ac.it.shibaura.android.gyroscope.RTMonAndroidOfGyroscope;
...
public class RTMonAndroidImpl extends RTCBase {
	...
	private static RTMonAndroidOfGyroscope	myRTC = null;
	 ...
	 * @param mode データ型
	 */
	public RTMonAndroidImpl(RTMonAndroidOfGyroscope myRTC, RTCService rtcService) {
