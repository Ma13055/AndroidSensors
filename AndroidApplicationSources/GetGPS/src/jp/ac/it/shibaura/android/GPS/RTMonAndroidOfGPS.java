...
public class RTMonAndroidOfGPS extends Activity {
	...
	public void onResume() {
		...
		if(lm != null){
			lm.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, lel);
		}
	}
	...
	class LocationEventListener implements LocationListener{
		...
		public void onLocationChanged(Location location) {
			...
			RTCtm.set((int)location.getTime(), (int)System.nanoTime());
		}
