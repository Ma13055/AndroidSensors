 ...
 */
package jp.ac.it.shibaura.android.accele;
 ...
 * RTMonAndroid
 */
public class RTMonAndroidOfAcceleration extends Activity {
	...
	private double dataX = 0;			//加速度センサx軸情報
	private double dataY = 0;			//加速度センサy軸情報
	private double dataZ = 0;			//加速度センサz軸情報
	...
	private class NameServerConnectListenerImpl implements NameServerConnectListener {
		...
		public void onConnected() {
			Intent intent = new Intent(RTMonAndroidOfAcceleration.this, RTCService.class);
			startService(intent);
	...
	private class RtcServiceConnection implements ServiceConnection {
		...
		public void onServiceConnected(ComponentName className, IBinder service) {
			...
			rtcImpl = new RTMonAndroidImpl(RTMonAndroidOfAcceleration.this, rtcService);
