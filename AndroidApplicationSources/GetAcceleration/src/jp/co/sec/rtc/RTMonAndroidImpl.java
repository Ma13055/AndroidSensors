...
import jp.ac.it.shibaura.android.accele.RTMonAndroidOfAcceleration;
...
public class RTMonAndroidImpl extends RTCBase {
	...
	private static RTMonAndroidOfAcceleration	myRTC = null;
	 ...
	 * @param mode データ型
	 */
	public RTMonAndroidImpl(RTMonAndroidOfAcceleration myRTC, RTCService rtcService) {
