...
import jp.ac.it.shibaura.android.linearAccele.RTMonAndroidOfLinearAcceleration;
...
public class RTMonAndroidImpl extends RTCBase {
	...
	private static RTMonAndroidOfLinearAcceleration	myRTC = null;
	 ...
	 * @param mode データ型
	 */
	public RTMonAndroidImpl(RTMonAndroidOfLinearAcceleration myRTC, RTCService rtcService) {
