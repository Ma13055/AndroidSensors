...
public class RTMonAndroidProfile {
	...
	public static final String Name				= "AmbientTemperatureSensor";
	public static final String ImplementationId	= "AmbientTemperatureSensor";
	...
	// << out port >>
	public static final String OutPort1			= "OutDouble";
}
